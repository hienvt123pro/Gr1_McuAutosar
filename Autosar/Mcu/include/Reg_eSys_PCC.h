...
#define REG_ESYS_PCC_SW_PATCH_VERSION                4
...
/* PCC_FTFC - Note: FTFC is available in only 1xx series of devices. */
#define PCC_FTFC_ADDR32                     ((uint32)(PCC_BASEADDR + (uint32)0x00000080U))
/* PCC_FTFM - Note: FTFM is available in only 14xW series of devices */
#define PCC_FTFM_ADDR32                     ((uint32)(PCC_BASEADDR + (uint32)0x00000080U))
/* PCC_DMAMUX0 */
...
#define PCC_PCS_LPO128K_CLK_U32                    ((uint32)0x07000000U)
