...
/* PDB_BB_SEL_1_2 bits only support on 14xW series of devices */
#ifdef MCU_SIM_CHIPCTL_PDB_BB_SEL_1_2_SUPPORT
    #define SIM_CHIPCTL_INIT_MASK32                 ((uint32)0x00CF200FU)
#else
...
#else
    #define SIM_CHIPCTL_CLOCK_MASK32                ((uint32)0x00000FF0U)
#endif
...
#define SIM_CHIPCTL_PDB_BB_SEL1_MASK32          ((uint32)0x00400000U)
#define SIM_CHIPCTL_PDB_BB_SEL2_MASK32          ((uint32)0x00800000U)
...
/****************************************************/
    ...
    #else
        #define SIM_PLATGC_RWBITS_MASK32            ((uint32)0x0000003FU)
    #endif
#else
    #define SIM_PLATGC_RWBITS_MASK32            ((uint32)0x0000001FU)
#endif
