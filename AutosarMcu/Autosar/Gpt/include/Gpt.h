...
/* Check if this header file and Gpt_Cfg.h header file are of the same Software version */
#if (GPT_VENDOR_ID != GPT_VENDOR_ID_CFG)
    #error "Gpt.h and Gpt_Cfg.h have different vendor ids"
#endif
/* Check if this header file and GPT_CFG header file are of the same Autosar version */
...
*
* @implements Gpt_NotificationType_typedef
*/
